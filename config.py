...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/UFCUPDATES/MishiRobo",)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)
PRIVACY_LINK = getenv("PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-RishuMusic-01-09-2")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Crush_Vibes")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/MISHI_VIBES_DPZ")
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/kol1pd.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/xddya7.jpg")
